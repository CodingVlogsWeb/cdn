...
codeBlocks.forEach(function(t) {
    ...
    toggle.className = "Darkbtn", toggle.type = "button", toggle.innerHTML = "<span class='material-symbols-outlined'>brightness_6</span>", t.append(toggle), toggle.addEventListener("click", function(){
        dark();
     })
});
...
if (localStorage.getItem("codeDark")) {
  body.classList.add("dmCode");
}

function dark() {
  if (localStorage.getItem("codeDark")) {
    body.classList.remove('dmCode');
    localStorage.removeItem("codeDark");
  } else {
    body.classList.add('dmCode');
    localStorage.setItem("codeDark", "true");
  }
};
...
var csjs = function () {
    ...
    function j(e) {
        const t = {
            ...
            computed: {
                className() {
                    return this.unknownLanguage ? "" : "csjs " + this.detectedLanguage
                },
                highlighted() {
    ...
    return (e => {
        ...
        function E(e) {
            ...
            _("after:highlightBlock", {
                ...
                const s = t ? r[t] : n;
                e.classList.add("csjs"), s && e.classList.add(s)
...
"object" == typeof exports && "undefined" != typeof module && (module.exports = csjs);
csjs.registerLanguage("apache", (() => {
    "use strict";
    return e => {
        const n = {
            className: "number",
            ...
            const n = t.COMMENT("//", "$", {
                ...
                _ = {
                    ...
                    contains: [{
                        ...
                        keywords: u,
                        relevance: 0,
                        contains: [n, t.C_BLOCK_COMMENT_MODE, i, o, s, {
                            begin: /\(/,
                            end: /\)/,
                            keywords: u,
                            relevance: 0,
...
csjs.registerLanguage("coffeescript", (() => {
    "use strict";
...
csjs.registerLanguage("javascript", (() => {
    "use strict";
...
csjs.registerLanguage("makefile", (() => {
    "use strict";
    return e => {
        const i = {
            className: "variable",
...
csjs.registerLanguage("markdown", (() => {
    "use strict";
...
csjs.registerLanguage("objectivec", (() => {
    "use strict";
    return e => {
...
csjs.registerLanguage("perl", (() => {
    ...
    return n => {
        const t = /[dualxmsipn]{0,12}/,
            ...
            c = [a, n.HASH_COMMENT_MODE, n.COMMENT(/^=\w/, /=cut/, {
                endsWithParent: !0
            }), i, {
                    className: "string",
                    contains: o,
...
csjs.registerLanguage("php-template", (() => {
    "use strict";
    return n => ({
        name: "PHP template",
        subLanguage: "xml",
...
csjs.registerLanguage("plaintext", (() => {
    "use strict";
    return t => ({
        name: "Plain text",
        aliases: ["text", "txt"],
...
csjs.registerLanguage("properties", (() => {
    "use strict";
    return e => {
        var n = "[ \\t\\f]*",
            a = n + "[:=]" + n,
...
csjs.registerLanguage("python-repl", (() => {
    "use strict";
    return s => ({
        aliases: ["pycon"],
        contains: [{
...
csjs.registerLanguage("typescript", (() => {
    "use strict";
    const e = "[A-Za-z$_][0-9A-Za-z$_]*",
        n = ["as", "in", "of", "if", "for", "while", "finally", "var", "new", "function", "do", "return", "void", "else", "break", "catch", "instanceof", "with", "throw", "case", "default", "try", "switch", "continue", "typeof", "delete", "let", "yield", "const", "class", "debugger", "async", "await", "static", "import", "from", "export", "extends"],
        a = ["true", "false", "null", "undefined", "NaN", "Infinity"],
            ...
            b = (r => {
                ...
                return {
                    ...
                    contains: [r.SHEBANG({
                        ...
                        begin: r.UNDERSCORE_IDENT_RE + "\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",
                        returnBegin: !0,
                        contains: [A, r.inherit(r.TITLE_MODE, {
                            begin: c
                        })]
                    }, {
                        variants: [{
...
(function (w, d) {
    ...
    var TABLE_NAME = 'csjs-ln',
        LINE_NAME = 'csjs-ln-line',
        CODE_BLOCK_NAME = 'csjs-ln-code',
        NUMBERS_BLOCK_NAME = 'csjs-ln-numbers',
        NUMBER_LINE_NAME = 'csjs-ln-n',
    ...
    function documentReady(options) {
        try {
            var blocks = d.querySelectorAll('code.csjs,code.nohighlight');
